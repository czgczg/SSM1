...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <input type="hidden" name="id" value="${list.result.id}" />
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span3">
		        <label>姓名：</label>
		     ...
		     <div class="span3">
		        ...
		        <select name="genderID" style="width:100%;height:26px;">
		            <c:forEach items="${listGender}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.genderID}">selected="selected"</c:if>>
		        ...
		        <label>民族：</label>
		         <select name="nationID" style="width:100%;height:26px;">
		            <c:forEach items="${listNation}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.nationID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>文化程度：</label>
		         <select name="educationDegreeID" style="width:100%;height:26px;">
		            <c:forEach items="${listEducationDegree}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.educationDegreeID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>旅客级别：</label>
		         <select name="passengerLevelID" style="width:100%;height:26px;">
		            <c:forEach items="${listPassengerLevel}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.passengerLevelID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select id="papersId" name="papersID" style="width:100%;height:26px;">
		            <c:forEach items="${listPapers}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.papersID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select name="thingReasonID" style="width:100%;height:26px;">
		            <c:forEach items="${listThingReason}" var="item">
			          <option value="${item.id}" <c:if test="${item.id==list.thingReasonID}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
